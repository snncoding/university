...
class ProfessorServiceTest {
    ...
    void setUp() {
        ...
        list = Lists.list(
                new Professor(1, "Test1", new Department(1, null)),
                new Professor(2, "Test2", new Department(2, null)),
                new Professor(3, "Test3", new Department(1, null))
        );
    }
    ...
    void getAll() {
        ...
        List<ProfessorDTO> dto = service.getAll();
        assertNotNull(dto);
    ...
    void findById() {
        ...
        Professor entity = service.findById(1);
        assertNotNull(entity);
        assertEquals(entity.getId(), 1);

        when(repository.findById(4)).thenThrow(new MyEntityNotFoundException(4, service.PROFESSOR));
    ...
    void getById() {
        when(repository.findById(1)).thenReturn(Optional.of(list.get(0)));
        ProfessorDTO dto = service.getById(1);
        assertNotNull(dto);
